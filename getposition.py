...
def dowrite(F, string):
    F.write("{},{}".format(time.time(), string))
...
def main():
    ...
    parser.add_argument(
        "-u", "--url", help="Base URL to use", type=str, default="http://192.168.7.1"
    )
    ...
    with open("waterlinked.dat", "w") as F:
        while True:
            ...
            if acoustic_position:
                if antenna_position:
                    ...
                    print(
                        "Current acoustic position relative to antenna. X: {}, Y: {}, Z: {}".format(
                    ...
                    print(
                        "Current acoustic position. X: {}, Y: {}, Z: {}".format(
                            acoustic_position["x"],
                            acoustic_position["y"],
                            acoustic_position["z"],
                        )
            ...
            if global_position:
                if depth:
                    print(
                        "Current global position. Latitude: {}, Longitude: {}, Depth: {}".format(
                            global_position["lat"], global_position["lon"], depth
                        )
                    )
                    dowrite(
                        F,
                    ...
                    print(
                        "Current global position latitude :{} longitude :{}".format(
